...
module.exports = {
  ...
  datastores: {
    ...
    default: {
      ...
      //url is set via environment variable like the below comment recommends
      //--------------------------------------------------------------------------
   ...
   **************************************************************************/
  ssl: {
    key: require('fs').readFileSync(require('path').resolve(__dirname, '../ssl/matchbook.key')),
    cert: require('fs').readFileSync(require('path').resolve(__dirname, '../ssl/matchbook.crt'))
  },
